...
**Full Stack Developer** — Laravel, WordPress & PHP
...
|---------|-------------|-------|
| **[Asaas PHP Actions](https://github.com/LucasTonolli/asaas-php-actions)** | Open-source PHP package for Asaas payment gateway integration | PHP |
| **Zintbot** | SaaS integrating WhatsApp with ChatGPT for automated customer service | Laravel, ChatGPT API |
| **[Avantgarde College](https://avantgardecollege.com.br)** | E-commerce for medical courses with Zoom API integration | WordPress, WooCommerce, PHP |
